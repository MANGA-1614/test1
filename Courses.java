...
public class Courses {
    ...
    public Edge<CourseRequisite> putRequisite(CourseNumber courseNum1, CourseNumber courseNum2, CourseRequisite requisite) throws InvalidCourseNumberException, CircularPreRequisiteException 
    {
    	...
    	if ( (courseNum1.compareTo(courseNum2) == 0) || (this.getRequisite(courseNum2, courseNum1) != null) )
    	{
    		throw new CircularPreRequisiteException();
    	}
    	
    	if ( (courseNum1.getCourseNumber() < 1 || courseNum1.getCourseNumber() > 9999) || (courseNum2.getCourseNumber() < 1 || courseNum2.getCourseNumber() > 9999) ) 
    	{
            throw new InvalidCourseNumberException();
        }
    	
    	courseGraph.insertEdge(course1.getCourseVertex(), course2.getCourseVertex(), requisite);
